...
注意：形参可以获取被监听的数据，srae.getName()  获取监听数据的键，srae.getValue() 获取监听数据的值
...
注意:形参可以获取被监听的数据，event.getName() 	获取数据的键名；event.getValue()	获取数据的值
...
注意：形参可以获取当前监听的数据，event.getName()  获取数据的键名，event.getValue() 获取数据的值
